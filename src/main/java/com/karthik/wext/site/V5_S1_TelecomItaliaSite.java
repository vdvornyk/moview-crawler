...
public class V5_S1_TelecomItaliaSite extends AbstractSiteStrategy {
	public static final Logger logger = LoggerFactory.getLogger(V5_S1_TelecomItaliaSite.class);
