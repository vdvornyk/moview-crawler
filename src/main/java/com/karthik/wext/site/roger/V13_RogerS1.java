...
public class V13_RogerS1 extends V13_RogerAbstract {

	public static String BASE_URL = "http://www.rogersondemand.com/movies/search?titletype=Movie&searchtype=Genre";
