...
public class V15_HuluS3 extends V15_HuluAbstract {

	public static String BASE_URL = "http://www.hulu.com/browse/search?alphabet=All&family_friendly=0&closed_captioned=0&has_free=0&has_huluplus=0&has_hd=0&channel=All&subchannel=&network=&rating=All&display=Full%20length%20movies%20only&decade=All&type=movies&view_as_thumbnail=false&block_num=BLKNUM&pgid=3";
