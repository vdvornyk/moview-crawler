...
public class V15_HuluS6 extends V15_HuluAbstract {
	public static final Logger logger = LoggerFactory.getLogger(V15_HuluS6.class);
	public static String BASE_URL = "http://www.hulu.com/browse/search?keyword=& family_friendly=0&closed_captioned=0&has_free=1&has_huluplus=0&has_hd=0&channel=All&subchannel=&network=All&rating=&display=Shows%20with%20full%20episodes%20only&decade=All&type=tv&view_as_thumbnail=false&block_num=";
