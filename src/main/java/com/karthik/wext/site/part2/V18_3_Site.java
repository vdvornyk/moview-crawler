...
public class V18_3_Site extends AbstractSiteStrategy {
	...
	class Param {
		...
		public String mainArea = "wissendoku";
		public int page;
		public String pageId = "wissendoku_genreformateaz_genre_all";
		public String route = "/wissendoku/genre_all-filme";
