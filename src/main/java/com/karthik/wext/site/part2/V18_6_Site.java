...
public class V18_6_Site extends AbstractSiteStrategy {
	private static final COLUMN columnNames[] = new COLUMN[] { COLUMN.MainTitle, COLUMN.SubGenre, COLUMN.Year };
	...
	class Param {
		...
		public String mainArea = "spielfilm";
		public int page;
		public String pageId = "spielfilm_genre_all";
		public String route = "/spielfilm/all";
		public String sort = null;
		public String subNav = "genre";
	...
	public class Item {
		public Item(JSONObject object) {
			...
			videoMainList = new VideoMainList((JSONArray) object.get("videoMainList"));
		...
		public MovieInfo toMovieInfo() {
			...
			movieInfo.setYear(videoMainList.getYear());
			return movieInfo;
		}
	...
	public class VideoMainList {
		...
		public VideoMainList(JSONArray array) {
			JSONObject obj = (JSONObject) array.get(0);
			String strWithYear = obj.get("basename").toString();
			String parseBaseName[] = strWithYear.split("_");
			year = parseBaseName[parseBaseName.length - 1];
		}
