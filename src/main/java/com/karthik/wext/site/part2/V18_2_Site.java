...
public class V18_2_Site extends AbstractSiteStrategy {
	...
	class Param {
		...
		public String mainArea = "kids";
		public int page;
		public String pageId = "kids_genreformateaz_genre_all";
		public String route = "/kids/genre_all-filme";
